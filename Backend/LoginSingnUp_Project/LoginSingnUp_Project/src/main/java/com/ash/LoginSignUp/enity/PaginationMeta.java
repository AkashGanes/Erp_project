...
public class PaginationMeta<T> {
		...
		public static <T> PaginationMeta<T> createPagination(Page<T> page) {
	    	
	    	PaginationMeta<T> paginationMeta=new PaginationMeta<>();
	        ...
	        paginationMeta.setListUser(page.getContent());
